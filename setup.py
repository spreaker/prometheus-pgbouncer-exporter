...
setup(
  ...
  download_url                  = 'https://github.com/spreaker/prometheus-pgbouncer-exporter/archive/2.1.3.tar.gz',
  keywords                      = ['prometheus', 'pgbouncer'],
  classifiers                   = [],
  python_requires               = ' >= 3',
  install_requires              = ['psycopg2 == 2.9.10', 'prometheus_client==0.8.0', 'python-json-logger==0.1.11', 'PyYAML>=5.4.1'],
  entry_points                  = {
    'console_scripts': [
